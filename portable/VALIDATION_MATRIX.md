...
The PASS entries below are an imported historical validation baseline from the
pre-split `mrcha033/skills` repository. They are not standalone-repository run
results.
...
## Historical native Windows evidence
